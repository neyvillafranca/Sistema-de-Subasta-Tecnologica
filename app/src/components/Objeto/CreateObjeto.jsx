...
const schema = yup.object({
  ...
  condicion: yup
    .string()
    .required("Seleccione la condición"),
...
export default function CreateObjeto() {
  ...
  // Usuario simulado (ID del usuario actual)
  const usuarioActual = {
    id_usuario: 2
  };
  ...
  useEffect(() => {
    ...
    const loadUsuario = async () => {
      ...
      try {
        ...
        const res = await UsuarioService.getUserById(usuarioActual.id_usuario);
        ...
        toast.error("Error al cargar usuario vendedor");
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!idObjeto) {
        ...
        console.error("Respuesta servidor:", resObjeto.data);
      ...
      toast.success("Objeto creada correctamente");
    ...
    <Card className="p-6 max-w-4xl mx-auto mt-8 shadow-lg">
      ...
      >
        ...
        <div>
          ...
          <div className="w-full border rounded-md p-2 bg-gray-100 font-bold text-green-600">
